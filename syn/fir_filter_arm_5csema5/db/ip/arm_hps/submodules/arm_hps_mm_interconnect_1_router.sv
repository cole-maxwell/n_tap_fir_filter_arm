...
module arm_hps_mm_interconnect_1_router_default_decode
  #(
...
module arm_hps_mm_interconnect_1_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    arm_hps_mm_interconnect_1_router_default_decode the_default_decode(
