...
`timescale 1 ps / 1 ps
module arm_hps_mm_interconnect_0 (
		input  wire [11:0] cpu_h2f_axi_master_awid,                                        //                                       cpu_h2f_axi_master.awid
		input  wire [29:0] cpu_h2f_axi_master_awaddr,                                      //                                                         .awaddr
		input  wire [3:0]  cpu_h2f_axi_master_awlen,                                       //                                                         .awlen
		input  wire [2:0]  cpu_h2f_axi_master_awsize,                                      //                                                         .awsize
		input  wire [1:0]  cpu_h2f_axi_master_awburst,                                     //                                                         .awburst
		input  wire [1:0]  cpu_h2f_axi_master_awlock,                                      //                                                         .awlock
		input  wire [3:0]  cpu_h2f_axi_master_awcache,                                     //                                                         .awcache
		input  wire [2:0]  cpu_h2f_axi_master_awprot,                                      //                                                         .awprot
		input  wire        cpu_h2f_axi_master_awvalid,                                     //                                                         .awvalid
		output wire        cpu_h2f_axi_master_awready,                                     //                                                         .awready
		input  wire [11:0] cpu_h2f_axi_master_wid,                                         //                                                         .wid
		input  wire [31:0] cpu_h2f_axi_master_wdata,                                       //                                                         .wdata
		input  wire [3:0]  cpu_h2f_axi_master_wstrb,                                       //                                                         .wstrb
		input  wire        cpu_h2f_axi_master_wlast,                                       //                                                         .wlast
		input  wire        cpu_h2f_axi_master_wvalid,                                      //                                                         .wvalid
		output wire        cpu_h2f_axi_master_wready,                                      //                                                         .wready
		output wire [11:0] cpu_h2f_axi_master_bid,                                         //                                                         .bid
		output wire [1:0]  cpu_h2f_axi_master_bresp,                                       //                                                         .bresp
		output wire        cpu_h2f_axi_master_bvalid,                                      //                                                         .bvalid
		input  wire        cpu_h2f_axi_master_bready,                                      //                                                         .bready
		input  wire [11:0] cpu_h2f_axi_master_arid,                                        //                                                         .arid
		input  wire [29:0] cpu_h2f_axi_master_araddr,                                      //                                                         .araddr
		input  wire [3:0]  cpu_h2f_axi_master_arlen,                                       //                                                         .arlen
		input  wire [2:0]  cpu_h2f_axi_master_arsize,                                      //                                                         .arsize
		input  wire [1:0]  cpu_h2f_axi_master_arburst,                                     //                                                         .arburst
		input  wire [1:0]  cpu_h2f_axi_master_arlock,                                      //                                                         .arlock
		input  wire [3:0]  cpu_h2f_axi_master_arcache,                                     //                                                         .arcache
		input  wire [2:0]  cpu_h2f_axi_master_arprot,                                      //                                                         .arprot
		input  wire        cpu_h2f_axi_master_arvalid,                                     //                                                         .arvalid
		output wire        cpu_h2f_axi_master_arready,                                     //                                                         .arready
		output wire [11:0] cpu_h2f_axi_master_rid,                                         //                                                         .rid
		output wire [31:0] cpu_h2f_axi_master_rdata,                                       //                                                         .rdata
		output wire [1:0]  cpu_h2f_axi_master_rresp,                                       //                                                         .rresp
		output wire        cpu_h2f_axi_master_rlast,                                       //                                                         .rlast
		output wire        cpu_h2f_axi_master_rvalid,                                      //                                                         .rvalid
		input  wire        cpu_h2f_axi_master_rready,                                      //                                                         .rready
		input  wire        clk_50mhz_clk_clk,                                              //                                            clk_50mhz_clk.clk
		input  wire        cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset, // cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset.reset
	...
	wire          rsp_mux_src_valid;                               // rsp_mux:src_valid -> cpu_h2f_axi_master_agent:write_rp_valid
	wire  [120:0] rsp_mux_src_data;                                // rsp_mux:src_data -> cpu_h2f_axi_master_agent:write_rp_data
	wire          rsp_mux_src_ready;                               // cpu_h2f_axi_master_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                             // rsp_mux:src_channel -> cpu_h2f_axi_master_agent:write_rp_channel
	wire          rsp_mux_src_startofpacket;                       // rsp_mux:src_startofpacket -> cpu_h2f_axi_master_agent:write_rp_startofpacket
	wire          rsp_mux_src_endofpacket;                         // rsp_mux:src_endofpacket -> cpu_h2f_axi_master_agent:write_rp_endofpacket
	wire          rsp_mux_001_src_valid;                           // rsp_mux_001:src_valid -> cpu_h2f_axi_master_agent:read_rp_valid
	wire  [120:0] rsp_mux_001_src_data;                            // rsp_mux_001:src_data -> cpu_h2f_axi_master_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                           // cpu_h2f_axi_master_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                         // rsp_mux_001:src_channel -> cpu_h2f_axi_master_agent:read_rp_channel
	wire          rsp_mux_001_src_startofpacket;                   // rsp_mux_001:src_startofpacket -> cpu_h2f_axi_master_agent:read_rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                     // rsp_mux_001:src_endofpacket -> cpu_h2f_axi_master_agent:read_rp_endofpacket
	...
	wire  [121:0] ram_s1_agent_rf_source_data;                     // ram_s1_agent:rf_source_data -> ram_s1_agent_rsp_fifo:in_data
	...
	wire  [121:0] ram_s1_agent_rsp_fifo_out_data;                  // ram_s1_agent_rsp_fifo:out_data -> ram_s1_agent:rf_sink_data
	...
	wire          cpu_h2f_axi_master_agent_write_cp_valid;         // cpu_h2f_axi_master_agent:write_cp_valid -> router:sink_valid
	wire  [120:0] cpu_h2f_axi_master_agent_write_cp_data;          // cpu_h2f_axi_master_agent:write_cp_data -> router:sink_data
	wire          cpu_h2f_axi_master_agent_write_cp_ready;         // router:sink_ready -> cpu_h2f_axi_master_agent:write_cp_ready
	wire          cpu_h2f_axi_master_agent_write_cp_startofpacket; // cpu_h2f_axi_master_agent:write_cp_startofpacket -> router:sink_startofpacket
	wire          cpu_h2f_axi_master_agent_write_cp_endofpacket;   // cpu_h2f_axi_master_agent:write_cp_endofpacket -> router:sink_endofpacket
	...
	wire          cpu_h2f_axi_master_agent_read_cp_valid;          // cpu_h2f_axi_master_agent:read_cp_valid -> router_001:sink_valid
	wire  [120:0] cpu_h2f_axi_master_agent_read_cp_data;           // cpu_h2f_axi_master_agent:read_cp_data -> router_001:sink_data
	wire          cpu_h2f_axi_master_agent_read_cp_ready;          // router_001:sink_ready -> cpu_h2f_axi_master_agent:read_cp_ready
	wire          cpu_h2f_axi_master_agent_read_cp_startofpacket;  // cpu_h2f_axi_master_agent:read_cp_startofpacket -> router_001:sink_startofpacket
	wire          cpu_h2f_axi_master_agent_read_cp_endofpacket;    // cpu_h2f_axi_master_agent:read_cp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [120:0] ram_s1_agent_rp_data;                            // ram_s1_agent:rp_data -> router_002:sink_data
	...
	wire          cmd_mux_src_valid;                               // cmd_mux:src_valid -> ram_s1_burst_adapter:sink0_valid
	wire  [120:0] cmd_mux_src_data;                                // cmd_mux:src_data -> ram_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                               // ram_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                             // cmd_mux:src_channel -> ram_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                       // cmd_mux:src_startofpacket -> ram_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                         // cmd_mux:src_endofpacket -> ram_s1_burst_adapter:sink0_endofpacket
	wire          ram_s1_burst_adapter_source0_valid;              // ram_s1_burst_adapter:source0_valid -> ram_s1_agent:cp_valid
	wire  [120:0] ram_s1_burst_adapter_source0_data;               // ram_s1_burst_adapter:source0_data -> ram_s1_agent:cp_data
	...
	altera_merlin_axi_master_ni #(
		...
		.ST_CHANNEL_W              (2),
		.ID                        (0)
	) cpu_h2f_axi_master_agent (
		.aclk                   (clk_50mhz_clk_clk),                                               //              clk.clk
		.aresetn                (~cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //        clk_reset.reset_n
		.write_cp_valid         (cpu_h2f_axi_master_agent_write_cp_valid),                         //         write_cp.valid
		.write_cp_data          (cpu_h2f_axi_master_agent_write_cp_data),                          //                 .data
		.write_cp_startofpacket (cpu_h2f_axi_master_agent_write_cp_startofpacket),                 //                 .startofpacket
		.write_cp_endofpacket   (cpu_h2f_axi_master_agent_write_cp_endofpacket),                   //                 .endofpacket
		.write_cp_ready         (cpu_h2f_axi_master_agent_write_cp_ready),                         //                 .ready
		...
		.read_cp_valid          (cpu_h2f_axi_master_agent_read_cp_valid),                          //          read_cp.valid
		.read_cp_data           (cpu_h2f_axi_master_agent_read_cp_data),                           //                 .data
		.read_cp_startofpacket  (cpu_h2f_axi_master_agent_read_cp_startofpacket),                  //                 .startofpacket
		.read_cp_endofpacket    (cpu_h2f_axi_master_agent_read_cp_endofpacket),                    //                 .endofpacket
		.read_cp_ready          (cpu_h2f_axi_master_agent_read_cp_ready),                          //                 .ready
		...
		.awid                   (cpu_h2f_axi_master_awid),                                         // altera_axi_slave.awid
		.awaddr                 (cpu_h2f_axi_master_awaddr),                                       //                 .awaddr
		.awlen                  (cpu_h2f_axi_master_awlen),                                        //                 .awlen
		.awsize                 (cpu_h2f_axi_master_awsize),                                       //                 .awsize
		.awburst                (cpu_h2f_axi_master_awburst),                                      //                 .awburst
		.awlock                 (cpu_h2f_axi_master_awlock),                                       //                 .awlock
		.awcache                (cpu_h2f_axi_master_awcache),                                      //                 .awcache
		.awprot                 (cpu_h2f_axi_master_awprot),                                       //                 .awprot
		.awvalid                (cpu_h2f_axi_master_awvalid),                                      //                 .awvalid
		.awready                (cpu_h2f_axi_master_awready),                                      //                 .awready
		.wid                    (cpu_h2f_axi_master_wid),                                          //                 .wid
		.wdata                  (cpu_h2f_axi_master_wdata),                                        //                 .wdata
		.wstrb                  (cpu_h2f_axi_master_wstrb),                                        //                 .wstrb
		.wlast                  (cpu_h2f_axi_master_wlast),                                        //                 .wlast
		.wvalid                 (cpu_h2f_axi_master_wvalid),                                       //                 .wvalid
		.wready                 (cpu_h2f_axi_master_wready),                                       //                 .wready
		.bid                    (cpu_h2f_axi_master_bid),                                          //                 .bid
		.bresp                  (cpu_h2f_axi_master_bresp),                                        //                 .bresp
		.bvalid                 (cpu_h2f_axi_master_bvalid),                                       //                 .bvalid
		.bready                 (cpu_h2f_axi_master_bready),                                       //                 .bready
		.arid                   (cpu_h2f_axi_master_arid),                                         //                 .arid
		.araddr                 (cpu_h2f_axi_master_araddr),                                       //                 .araddr
		.arlen                  (cpu_h2f_axi_master_arlen),                                        //                 .arlen
		.arsize                 (cpu_h2f_axi_master_arsize),                                       //                 .arsize
		.arburst                (cpu_h2f_axi_master_arburst),                                      //                 .arburst
		.arlock                 (cpu_h2f_axi_master_arlock),                                       //                 .arlock
		.arcache                (cpu_h2f_axi_master_arcache),                                      //                 .arcache
		.arprot                 (cpu_h2f_axi_master_arprot),                                       //                 .arprot
		.arvalid                (cpu_h2f_axi_master_arvalid),                                      //                 .arvalid
		.arready                (cpu_h2f_axi_master_arready),                                      //                 .arready
		.rid                    (cpu_h2f_axi_master_rid),                                          //                 .rid
		.rdata                  (cpu_h2f_axi_master_rdata),                                        //                 .rdata
		.rresp                  (cpu_h2f_axi_master_rresp),                                        //                 .rresp
		.rlast                  (cpu_h2f_axi_master_rlast),                                        //                 .rlast
		.rvalid                 (cpu_h2f_axi_master_rvalid),                                       //                 .rvalid
		.rready                 (cpu_h2f_axi_master_rready),                                       //                 .rready
	...
	arm_hps_mm_interconnect_0_router router (
		.sink_ready         (cpu_h2f_axi_master_agent_write_cp_ready),                        //      sink.ready
		.sink_valid         (cpu_h2f_axi_master_agent_write_cp_valid),                        //          .valid
		.sink_data          (cpu_h2f_axi_master_agent_write_cp_data),                         //          .data
		.sink_startofpacket (cpu_h2f_axi_master_agent_write_cp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (cpu_h2f_axi_master_agent_write_cp_endofpacket),                  //          .endofpacket
		.clk                (clk_50mhz_clk_clk),                                              //       clk.clk
		.reset              (cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arm_hps_mm_interconnect_0_router router_001 (
		.sink_ready         (cpu_h2f_axi_master_agent_read_cp_ready),                         //      sink.ready
		.sink_valid         (cpu_h2f_axi_master_agent_read_cp_valid),                         //          .valid
		.sink_data          (cpu_h2f_axi_master_agent_read_cp_data),                          //          .data
		.sink_startofpacket (cpu_h2f_axi_master_agent_read_cp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (cpu_h2f_axi_master_agent_read_cp_endofpacket),                   //          .endofpacket
		.clk                (clk_50mhz_clk_clk),                                              //       clk.clk
		.reset              (cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arm_hps_mm_interconnect_0_router_002 router_002 (
	...
	arm_hps_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_50mhz_clk_clk),                                              //       clk.clk
		.reset              (cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arm_hps_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_50mhz_clk_clk),                                              //       clk.clk
		.reset              (cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arm_hps_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_50mhz_clk_clk),                      //       clk.clk
		.reset               (ram_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arm_hps_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_50mhz_clk_clk),                      //       clk.clk
		.reset              (ram_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arm_hps_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_50mhz_clk_clk),                                              //       clk.clk
		.reset               (cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arm_hps_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_50mhz_clk_clk),                                              //       clk.clk
		.reset               (cpu_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
